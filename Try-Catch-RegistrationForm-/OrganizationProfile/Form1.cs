...
namespace OrganizationProfile
{
    public partial class frmRegistration : Form
    {
        ...
        public long StudentNumber(string studNum)
        {
            ...
            {
                throw new ArgumentNullException("Invalid input! Please input the correct student number");
            }
        ...
        public long ContactNo(string Contact)
        {
            ...
            {
                throw new IndexOutOfRangeException("Invalid input! Please input the correct contact number.");
            }
        ...
        public string FullName(string LastName, string FirstName, string MiddleInitial)
        {
            ...
            {
                throw new FormatException("Invalid input! Please complete of your full name.");
            }
        ...
        public int Age(string age)
        {
            ...
            {
                throw new OverflowException("Input your valid age.");
            }
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Message: Input Valid Age. " + OE.Message);
            }
            finally
            {
                //execute everytime
